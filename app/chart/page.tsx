 ...
 * 组件，渲染一张完整紫微命�?+ 基础解读，并支持本命 / 大限 / 流年切换�? *
 * 说明：线上商业版的完整交互界面（重设计的�?UI、AI 流式解读、合盘、分�? * 卡片等）不在开源范围内；但排盘内核——安星算法、四化、格局识别、古籍库—�? * 完全开放（�?lib/ziwei/*），可自由二次开发出你自己的界面�? */
